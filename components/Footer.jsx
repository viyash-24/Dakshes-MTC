        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 sm:gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="mailto:vigneshwaranvikki02@gmail.com" className="text-sm text-brand-400 dark:text-brand-600 hover:text-white transition-colors duration-300 flex items-center gap-2 break-all sm:break-normal">
